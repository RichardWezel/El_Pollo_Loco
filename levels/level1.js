...
[
    ...
    new BackgroundObject('img/5_background/layers/2_second_layer/2.png', 719), // Kakten
    new BackgroundObject('img/5_background/layers/1_first_layer/2.png', 719), // bunt Kakten
    new BackgroundObjectLargWidth('img/5_background/layers/air.png', 719 * 2), // Himmel ; wir din den constructor reingegeben
    new BackgroundObjectLargWidth('img/5_background/layers/3_third_layer/full.png', 719 * 2),// Berge
    new BackgroundObjectLargWidth('img/5_background/layers/2_second_layer/full.png', 719 * 2), // Kakten
    new BackgroundObjectLargWidth('img/5_background/layers/1_first_layer/full.png', 719 * 2), // bunt Kakten
