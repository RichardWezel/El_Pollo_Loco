const level1 = new Level(
    ...
    [
        new CollectableObjects('images/bottle/solo/salsa_bottle_stuck_left.png', 370),
        new CollectableObjects('images/bottle/solo/salsa_bottle_stuck_left.png', 2570),
        new CollectableObjects('images/bottle/solo/salsa_bottle_stuck_left.png', 3270),
        new CollectableObjects('images/bottle/solo/salsa_bottle_stuck_left.png', 270),
